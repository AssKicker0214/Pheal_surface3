...
<body>
<?php
include("presentation/tool/Builder.php5");
//require("../tool/NavBar.php5");
buildNavBar('me');
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="input-group date form_datetime col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                    <input id="date-input" class="form-control" size="16" type="text" value="" readonly onclick="dateClick()">
